          ...
          <div className="grid gap-10 md:grid-cols-2 md:gap-16">
            <div>
              ...
              <p className="mt-4 max-w-xl text-lg text-muted-foreground">
                ...
                they become a client, you earn 10% of the first $100,000 they
                pay us, every month, for a full year. Refer as many as you like.
              </p>
              <ul className="mt-6 space-y-3 text-muted-foreground">
                {[
                  "Refer anyone. You never sign anything to send us a name.",
                  "They become a client. We do the work and close it.",
                  "You get paid. 10% of collected revenue, monthly, for 12 months. Above $100,000 the rate steps down, and one client tops out at $50,000.",
                ].map((step, i) => (
